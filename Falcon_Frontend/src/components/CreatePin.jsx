  ...
  return (
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
      ...
      <div className='flex flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
            ...
            {!imageAsset?(
              <label htmlFor="" className='relative'>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <p className='mt-32 text-gray-400'>use high quality JPG, SVG, PNG or GIFless then 20MB</p>
                </div>
        ...
        <div className='flex flex-1 flex-col gap-6 border-b-2border-b-2 w-full'>
          <input type="text" value={title} onChange={(e)=>setTitle(e.target.value)} placeholder='Add your title' 
          className='text-xl sm:text-2xl font-medium border-gray-200 p-1 mt-5 border-b-2 rounded-lg' />
          {user&&(
          ...
          className='text-xl sm:text-lg font-base border-gray-200 p-1 border-b-2 rounded-lg' />
          
          <input type="text" value={destination} onChange={(e)=>setDestination(e.target.value)} placeholder='Add a destination link' 
          className='text-xl sm:text-lg font-base border-gray-200 p-1 border-b-2 my-5 rounded-lg' />

          <div className='flex flex-col'>
          <div className=''>
            <p className='mb-2 font-semibold text-lg sm:text-xl'>Choose pin category</p>
            <select onChange={(e)=>setCategory(e.target.value)}
            className='outline-none w-1/2 text-base border-b-2 border-gray-200 p-2 rounded-md cursor-pointer'
            >
          ...
          <div className='flex justify-end items-end mt-5'>
            <button type='button' onClick={savePin} className='bg-red-500 text-white font-bold p-2 rounded-full w-28 outline-none'>Upload Pin</button>
          </div>
          </div>        
        </div>
