...
const Navbar = ({searchTerm,setSearchTerm,user}) => {
  ...
  return (
    <div className='flex justify-center items-center gap-2 md:gap-5 w-full mt-5 pb-7'>
      <div className='flex justify-start items-center w-full px-2 rounded-md bg-white border-none outline-none focus-within:shadow-lg shadow-sm'>
